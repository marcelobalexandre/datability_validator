require 'date_localizer'

class DatabilityValidator < ActiveModel::EachValidator
  CHECKS = {
    greater_than: :>,
  ...
  def validate_each(record, attribute, value)
    ...
    unless is_date?(value)
      record.errors.add(attribute, I18n.t(:invalid, scope: [:errors, :messages]))
      return
    end
